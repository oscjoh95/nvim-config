    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ds', require('kickstart.plugins.telescope.telescopePickers').prettyDocumentSymbols, '[D]ocument [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>ws', require('kickstart.plugins.telescope.telescopePickers').prettyWorkspaceSymbols, '[W]orkspace [S]ymbols')
